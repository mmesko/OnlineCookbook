...
{
    public class PreparationStepFilter 
    {
        ...
        public PreparationStepFilter(string sortOrder, int pageNumber, int pageSize)
        {
            try
            {
        ...
        public PreparationStepFilter(string sortOrder, string sortDirection, int pageNumber, int pageSize)
        {
            try
            {
