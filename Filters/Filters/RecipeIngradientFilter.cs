...
{
    public class RecipeIngradientFilter : IFilter
    {
        ...
        public RecipeIngradientFilter(string sortOrder, int pageNumber, int pageSize)
        {
            try
            {
        ...
        public RecipeIngradientFilter(string sortOrder, string sortDirection, int pageNumber, int pageSize)
        {
            try
            {
