...
namespace OnlineCookbook.Common.Filters
{
    public class UserFilter : IFilter
    {
        ...
        private readonly string DefaultSortOrder = "Email";



         public UserFilter(string sortOrder, int pageNumber, int pageSize)
        {
            try
            {
         ...
         public UserFilter(string sortOrder, string sortDirection, int pageNumber, int pageSize)
        {
            try
            {
